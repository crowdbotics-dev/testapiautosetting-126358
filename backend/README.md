...
## Project Structure
    ...
    ├── testapiautosetting_126358  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_126358`
...
2. Clone this repo and `cd testapiautosetting_126358`
